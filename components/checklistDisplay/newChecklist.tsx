...
export default function NewChecklist(props: {formData:initialFormData; engineerData: { SDRE: string; QO: string }; hardwareLeads: string[]; manufacturerLeads: string[];}) {
  ...
  const saveProject = async () => {
    try {
      ...
      setSavingStatus("Project saved successfully! Please navigate to \"My Projects\" to EDIT this project. If you save again on this page, you will create another new project.");
